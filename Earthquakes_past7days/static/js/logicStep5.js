...
// define an object that contains overlays. visible all the time
let overlays = {
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
    L.geoJSON(data, {
        ...
        // create popup for circleMarker to display mag. and location after marker is created/styled
...
// Add custome legend to show color = magnitude
...
//Function to determine color of circle based on magnitude
